...
WORKDIR /tmp
RUN wget https://sourceforge.net/projects/cgru/files/2.2.3/cgru.2.2.3.CentOS-7.4.1708_x86_64.tar.gz

# Extract the archive to /tmp
RUN tar xfv  /tmp/cgru.2.2.3.CentOS-7.4.1708_x86_64.tar.gz -C /tmp/ 
